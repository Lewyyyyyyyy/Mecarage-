...
\begin{itemize}[noitemsep,leftmargin=1.5em]
  ...
  \item \textbf{Application mobile Android (Java + Firebase)}~: architecture
    REST-First avec Firebase comme canal de livraison temps réel (RTDB + FCM).
...
.NET, Angular, Python, Java, Firebase --- dans une solution cohérente a constitué
